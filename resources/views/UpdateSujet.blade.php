...
.container{
  ...
  margin-left: 230px;
  height: 560px; /* Hauteur fixe du conteneur du formulaire */
  overflow: auto;
  margin-top: 1.5%;
...
#lang{
    ...
    <div class="container">
        <div class="title" > Modifier sujet</div>
        <div class="content">
         @if(session('success'))
         ...
         @endif
        <form action="{{ route('sujet.update', $sujet->id) }}" method="POST">
          @csrf
          @method('PUT')
            <div class="user-details">
                <div class="input-box">
                    <span class="details"><strong>Sujet :</strong></span>
                    <input type="text" name="sujet"  value="{{ $sujet->sujet }}" placeholder="Enter le Sujet">
                </div>

                <div class="input-box">
                    <span class="details"><strong>Full Name d'Encadrant:</strong></span>
                    <input type="text" name="nameen" value="{{ $sujet->nameen }}" placeholder="Enter Full name d'Encadrant" required>
                </div>


                <div class="input-box">
                    <span class="details"><strong>Full name Stagiaire 1 :</strong> </span>
                    <input type="text" name="namestag1"   value="{{ $sujet->namestag1 }}" placeholder="Enter Full name de Stagiaire 1" required>
                </div>

                <div class="input-box">
                    <span class="details"><strong>Full Name Stagiaire 2 :</strong></span>
                    <input type="text" name="namestag2"  value="{{ $sujet->namestag2 }}" placeholder="Enter Full name de Stagiaire 2" required>
                </div>

                <span class="details"><strong>Les Langage de Programations :</strong> </span>
                <input type="text"  name="langage" value="{{ $sujet->langage }}"  placeholder="Enter Les Langage de Programations" id="lang">

                <span class="details"><strong>description:</strong> </span>
                <textarea name="descption" rows="6" placeholder="description" id="desc">{{ $sujet->descption }}</textarea>

                <div class="input-boxee">
                    <span class="details">Rapport</span>
                    <input type="file" name="rappoert" id="rappoert">
                </div>
            </div>
            <button  type="submit" class="btn btn-primary" style="margin-left:78%;">Modifier sujet</button>
        </form>
        </div>
      </div>
