...
[type=reset],
[type=submit] {
  --webkit-appearance: button;  /*hena zadena tiri*/
}
button:not(:disabled),
...
[type=search] {
  outline-offset: -2px;
  --webkit-appearance: textfield;   /*hena zadena tiri*/
}
...
::file-selector-button {
  font: inherit;
   --webkit-appearance: button;   /*henaaaa zadete- */
}
...
.success-message {
  ...
  margin-bottom: 10px;
    ...
    <section >
        <div class="container">
        <header style="color: #030303; margin-left: 40%; font-size: 25px;">Modifier Stagaire</header>
        @if(session('success'))
          <div class="success-message">{{ session('success') }}</div>
         @endif

        @if(session('error'))
         <div class="success-message">{{ session('error') }}</div>
        @endif
        <form action="{{ route('stagiaire.update', ['id' => $stagiaire->id]) }}" method="POST">
            @csrf
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input type="text" name="cin" value="{{ $stagiaire->cin }}" placeholder="Enter  CIN" required>
                        </div>
                        <div class="input-field">
                            <label><strong>full Name:</strong> </label>
                            <input type="text" name="name" value="{{ $stagiaire->name }}" placeholder="Enter Name" required>
                        </div>
                        <div class="input-field">
                            <label> <strong>Sex :</strong></label>
                            <select name="sex" required>
                                <option disabled selected>Select gender</option>
                                <option value="H" {{ $stagiaire->sex == 'H' ? 'selected' : '' }}>H</option>
                                <option value="F" {{ $stagiaire->sex == 'F' ? 'selected' : '' }}>F</option>
                                
                            </select>
                        </div>
                        <div class="input-field">
                            <label><strong>Age :</strong></label>
                            <input type="number" name="age"   value="{{ $stagiaire->age }}" placeholder="Enter Age" required>
                        </div>
                        <div class="input-field">
                            <label><strong>Mobile Number :</strong></label>
                            <input type="text" name="mobile" value="{{ $stagiaire->mobile }}" placeholder="Enter Mobile Number" required>
                            
                        </div>
                        <div class="input-field">
                            <label><strong>Email :</strong></label>
                            <input type="text" name="email" value="{{ $stagiaire->email }}" placeholder="Enter Email" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <select name="stage" required>
                                <option disabled selected>Select gender</option>
                                <option value="PFA" {{ $stagiaire->stage == 'PFA' ? 'selected' : '' }}>PFA</option>
                                <option value="PFE" {{ $stagiaire->stage == 'PFE' ? 'selected' : '' }}>PFE</option>
                                <option value="PFC" {{ $stagiaire->stage == 'PFC' ? 'selected' : '' }}>PFC</option>
                            </select>
                        </div>
                        <div class="input-field">
                            <label> <strong>Specialite du diplome :</strong></label>
                            <input type="text"  name="specialite" value="{{ $stagiaire->specialite }}" placeholder="Enter Specialite du diplome" required>
                        </div>
                        <div class="input-field">
                            <label><strong>Niveau d'etude :</strong></label>
                            <input type="text"  name="etude"  value="{{ $stagiaire->etude }}" placeholder="Enter Niveau d'etude" required>
                        </div>
                        <div class="input-field">
                            <label for="cv"><Strong>CV</Strong></label>
                            <input type="file"  name="new_cv" id="new-cv" accept=".pdf,.doc,.docx"    placeholder="Enter issued state" required >
                        </div>
                        <div class="input-field">
                            <label><strong>Date Debut :</strong></label>
                            <input type="date" name="datedebut" value="{{ $stagiaire->datedebut }}" placeholder="Enter your issued date" required>
                        </div>
                        <div class="input-field">
                            <label><strong>Date Fin :</strong></label>
                            <input type="date" name="datefin" value="{{ $stagiaire->datefin }}" placeholder="Enter expiry date" required>
                        </div>
                    </div>
