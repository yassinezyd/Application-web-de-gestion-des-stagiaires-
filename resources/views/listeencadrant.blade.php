            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Table Des Encadrants</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $encadrant->idont }}</td>
                                            <td>{{ $encadrant->name }}</td>
                                            <td>{{ $encadrant->mobile }}</td>
                                            <td>{{ $encadrant->email }}</td>
                                            <td>{{ $encadrant->specialite }}</td>
                                            <td>
                                                <a href="{{ route('encadrant.edit', $encadrant->id) }}" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-edit"></i> Modifier</a>
                                                    <form action="{{ route('encadrant.destroy', $encadrant->id) }}" method="POST" style="display: inline-block;">
                                                    @csrf
                                                    @method('DELETE')
