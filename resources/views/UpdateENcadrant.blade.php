    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="/logo" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-user fa-fw"></i></a>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    
                    <li><a class="dropdown-item" href="/logo">Logout</a></li>
                </ul>
            </li>
        </ul>
    </nav>
...
.user-details .input-box input:valid{
 ...
 form .button input:hover{
  ...
  margin-bottom: 10px;
    ...
    <section >
        <div class="container">
            <div class="title" >Modifier Encadrant</div>
            <div class="content">
              @if(session('success'))
              ...
              @method('PUT')
                <div class="user-details">
                  <div class="input-box">
                    <span class="details">ID idant :</span>
                    <input type="text" name="idant" value="{{ $encadrant->idont }}" placeholder="Enter ID idant" required>
                  </div>
                  <div class="input-box">
                    <span class="details">Full Name Encadrant :</span>
                    <input type="text" name="nom" value="{{ $encadrant->name }}" placeholder="Enter  Nom" required>
                  </div>
                  <!-- <div class="input-box">
                    <span class="details">prenom :</span>
                    <input type="text" placeholder="Enter prenom" required>
                  </div> -->
                  <div class="input-box">
                    <span class="details">Email :</span>
                    <input type="text"name="email" value="{{ $encadrant->email }}"  placeholder="Enter Eamil" required>
                  </div>
                  <div class="input-box">
                    <span class="details">Phone Number :</span>
                    <input type="text" name="telephone"  value="{{ $encadrant->mobile }}" placeholder="Enter Phone Number " required>
                  </div>
                  <div class="input-box">
                    <span class="details" >Specialite:</span>
                    <input type="text"  name="specialite" value="{{ $encadrant->specialite }}" placeholder="Enter Specialite" required>
                  </div>
                </div>
                
                </div>
                <button  type="submit" class="btn btn-primary" style="margin-left:73%;  margin-top: -20px;   margin-bottom: 4%;" > Modifier un Encadrant</button>
              </form>
            </div>
          </div>
